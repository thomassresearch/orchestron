...
export const SEQUENCER_UI_COPY: Record<GuiLanguage, SequencerUiCopy> = {
  english: {
    ...
    multitrackArrangerSelectionHint: "Click to seek and clear the loop; drag to select a loop range, including 1 beat",
    multitrackArrangerClearSelection: "Click anywhere on the ruler to clear the loop and seek",
  ...
  german: {
    ...
    multitrackArrangerSelectionHint: "Klicken zum Springen und Loeschen des Loops; ziehen fuer einen Loop-Bereich ab 1 Beat",
    multitrackArrangerClearSelection: "Auf die Leiste klicken, um den Loop zu loeschen und dorthin zu springen",
  ...
  french: {
    ...
    multitrackArrangerSelectionHint: "Cliquez pour deplacer la lecture et effacer la boucle ; glissez pour une boucle d'au moins 1 temps",
    multitrackArrangerClearSelection: "Cliquez sur la regle pour effacer la boucle et deplacer la lecture",
  ...
  spanish: {
    ...
    multitrackArrangerSelectionHint: "Haz clic para mover la reproduccion y borrar el bucle; arrastra para un bucle de al menos 1 pulso",
    multitrackArrangerClearSelection: "Haz clic en la regla para borrar el bucle y mover la reproduccion",
