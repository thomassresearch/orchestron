...
const en = {
  ...
  delete: "Delete definition", deleteHint: "Temporary workspace references expand into their contents; the definition’s own draft is removed.", changes: "Unapplied changes",
...
const de: Copy = {
  ...
  delete: "Definition löschen", deleteHint: "Temporäre Verweise werden in ihre Inhalte aufgelöst; der eigene Entwurf der Definition wird entfernt.", changes: "Nicht übernommene Änderungen",
...
const fr: Copy = {
  ...
  delete: "Supprimer la définition", deleteHint: "Les références temporaires sont développées ; le brouillon propre à la définition est supprimé.", changes: "Modifications non appliquées",
...
const es: Copy = {
  ...
  delete: "Eliminar definición", deleteHint: "Las referencias temporales se expanden en su contenido; se elimina el borrador de la definición.", changes: "Cambios sin aplicar",
