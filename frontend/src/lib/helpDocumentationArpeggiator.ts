...
Click #1–#8 to edit; hold the separate speaker for 250 ms to preview. Drag pads to copy. Editing stays on your selected pad while playback changes. A rhythm has 1–32 steps, independently of its pad duration (1–8 or 16 master beats). New pads use 16 sixteenths and four beats. Repeated identical pads continue the phrase; changing pads restarts it. Assemble reusable groups and supergroups in the upper-right workspace, then Apply shared edits; place them with rests in the multitrack arranger. Workspace Play loops its contents; speaker release restores prior playback. Arranger previews follow pad/rest boundaries; Live previews follow Next cycle or Next master bar. Input or held notes are required.
...
#1–#8 zum Bearbeiten wählen; den separaten Lautsprecher für eine Vorschau 250 ms halten. Ziehen kopiert Pads. Automatische Wechsel ändern das bearbeitete Pad nicht. Ein Rhythmus hat 1–32 Schritte, unabhängig von seiner Pad-Dauer (1–8 oder 16 Master-Beats). Standard: 16 Sechzehntel und vier Beats. Dasselbe Pad läuft über Wiederholungen weiter; ein anderes Pad startet die Phrase neu. Gruppen und Supergruppen in der Arbeitsfläche oben rechts zusammenstellen und gemeinsame Änderungen übernehmen; im Multitrack-Arranger mit Pausen platzieren. Play wiederholt die Arbeitsfläche; Loslassen stellt die vorherige Wiedergabe wieder her. Arrangement-Vorschauen folgen Pad-/Pausengrenzen, Live-Vorschauen dem nächsten Zyklus oder Master-Takt. Eingehende oder gehaltene Noten sind erforderlich.
...
Cliquez #1–#8 pour éditer ; maintenez le haut-parleur séparé 250 ms pour un aperçu. Glisser copie les pads. Les changements automatiques ne déplacent pas l’édition. Le cycle comporte 1–32 pas, indépendamment de la durée du pad (1–8 ou 16 temps maîtres). Par défaut : 16 doubles croches et quatre temps. Le même pad poursuit la phrase ; un pad différent la redémarre. Assemblez groupes et supergroupes dans l’atelier en haut à droite, appliquez explicitement les modifications partagées et placez-les dans l’arrangeur multipiste. Lecture répète l’atelier ; relâcher le haut-parleur restaure la lecture précédente. Les aperçus suivent les limites pad/silence en Arrangement, ou le prochain cycle/mesure maître en Live. Des notes entrantes ou maintenues sont nécessaires.
...
Pulse #1–#8 para editar; mantenga el altavoz separado 250 ms para escucharlo. Arrastrar copia pads. Los cambios automáticos conservan el pad editado. El ritmo tiene 1–32 pasos, independientemente de su duración (1–8 o 16 pulsos maestros). Por defecto: 16 semicorcheas y cuatro pulsos. Repetir el mismo pad continúa la frase; cambiar de pad la reinicia. Monta grupos y supergrupos en el taller superior derecho, aplica explícitamente las ediciones compartidas y colócalos en el arreglador multipista. Reproducir repite el taller; soltar el altavoz restaura la reproducción anterior. Las escuchas siguen los límites de pad/silencio en Arreglo, o el próximo ciclo/compás maestro en Live. Se requieren notas entrantes o retenidas.
