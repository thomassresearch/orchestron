...
const rows = {
  ...
  dragHint: ["Drop catalog nodes into cases · Alt/Option-drag to transfer case members", "Katalogknoten in Zweige ziehen · Alt/Option-Ziehen zum Wechseln der Zugehörigkeit", "Déposez les nœuds du catalogue dans les cas · Alt/Option-glisser pour transférer", "Arrastra nodos del catálogo a los casos · Alt/Opción-arrastrar para transferir"],
