...
Pad lengths are 1–16 local beats for melodic/drummer devices and 1–32 for controller devices, subject to 128 steps. Arpeggiators retain 1–8 or 16 master beats. Arpeggiator durations use master beats. Meter, subdivision and playback speed belong to the owning sequencer; tempo is shared.
...
Right-click an item, or use Shift+F10, for **Edit**, **Group**, **Supergroup**, **Ungroup**, and **Remove**. Ungroup expands one level locally and keeps the saved definition. Delete/Backspace removes selected workspace items and closes the gap. Use **Add rest…** for rests of 1, 2, 4, 8, 16 or 32 local beats. Long assemblies scroll horizontally; the saved phrase palette has a bounded height.
