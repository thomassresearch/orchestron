    ...
    def _load_builtin_opcodes(self) -> list[OpcodeSpec]:
        return [
            ...
            self._spec(
                name="grain3",
                category="oscillator",
                description="Granular oscillator with independent pitch and frequency modulation.",
                icon=self._icon("vco.svg"),
                inputs=[
                    PortSpec(
                        id="kamp",
                    ...
                    PortSpec(id="imaxovr", name="MaxOverlaps", signal_type=SignalType.INIT, default=64),
                    PortSpec(
                        id="kfn",
                        name="GrainTable",
                        signal_type=SignalType.CONTROL,
                ...
                outputs=[PortSpec(id="asig", name="aSig", signal_type=SignalType.AUDIO)],
                template=(
                    "{asig} grain3 {kamp}, {kcps}, {kfmd}, {kpmd}, {kgdur}, {kdens}, {imaxovr}, "
                    "{kfn}, {iwfn}, {iseed}, {imode}"
                ),
                tags=["sound", "source", "granular"],
            ),
            self._spec(
