    ...
    def _load_builtin_opcodes(self) -> list[OpcodeSpec]:
        return [
            ...
            self._spec(
                ...
                outputs=[PortSpec(id="kenv", name="kEnv", signal_type=SignalType.CONTROL)],
                template="{kenv} madsr {iatt}, {idec}, {islev}, {irel}, {idel}, {ireltim}",
                tags=["control", "modulation"],
            ),
            self._spec(
                name="mxadsr",
                ...
                outputs=[PortSpec(id="kenv", name="kEnv", signal_type=SignalType.CONTROL)],
                template="{kenv} mxadsr {iatt}, {idec}, {islev}, {irel}, {idel}, {ireltim}",
                tags=["control", "modulation"],
            ),
            self._spec(
                name="expseg",
            ...
            self._spec(
                name="expsegr",
                category="envelope",
                description="Control-rate exponential envelope with release segment.",
                icon=self._icon("adsr.svg"),
                inputs=[
                    PortSpec(id="ia", name="Start", signal_type=SignalType.INIT, default=0.001),
                    PortSpec(id="idur1", name="Dur1", signal_type=SignalType.INIT, default=0.05),
                    PortSpec(id="ib", name="Val1", signal_type=SignalType.INIT, default=1.0),
                    PortSpec(id="irel", name="ReleaseDur", signal_type=SignalType.INIT, default=0.15),
                    PortSpec(id="iz", name="ReleaseVal", signal_type=SignalType.INIT, default=0.001),
                ],
                outputs=[PortSpec(id="kenv", name="kEnv", signal_type=SignalType.CONTROL)],
                template="{kenv} expsegr {ia}, {idur1}, {ib}, {irel}, {iz}",
                tags=["control", "envelope", "segments", "release", "exponential"],
            ),
            self._spec(
                name="expon",
                category="envelope",
                description="Control-rate exponential segment between two points.",
                icon=self._icon("adsr.svg"),
                inputs=[
                    PortSpec(id="ia", name="Start", signal_type=SignalType.INIT, default=0.001),
                    PortSpec(id="idur", name="Dur", signal_type=SignalType.INIT, default=0.1),
                    PortSpec(id="ib", name="End", signal_type=SignalType.INIT, default=1.0),
                ],
                outputs=[PortSpec(id="kenv", name="kEnv", signal_type=SignalType.CONTROL)],
                template="{kenv} expon {ia}, {idur}, {ib}",
                tags=["control", "envelope", "exponential"],
            ),
            self._spec(
                name="linseg",
                category="envelope",
            ...
            self._spec(
                name="linenr",
                category="envelope",
                description="Control-rate envelope with note-release stage.",
                icon=self._icon("adsr.svg"),
                inputs=[
                    PortSpec(
                        id="kamp",
                    ...
                    PortSpec(id="irise", name="Rise", signal_type=SignalType.INIT, default=0.01),
                    PortSpec(id="idec", name="Decay", signal_type=SignalType.INIT, default=0.2),
                    PortSpec(id="iatdec", name="AttackDecay", signal_type=SignalType.INIT, default=0.01),
                ],
                outputs=[PortSpec(id="kenv", name="kEnv", signal_type=SignalType.CONTROL)],
                template="{kenv} linenr {kamp}, {irise}, {idec}, {iatdec}",
                tags=["control", "envelope", "release"],
            ),
            self._spec(
                name="envlpxr",
                category="envelope",
                description="Control-rate envelope with optional release scaling controls.",
                icon=self._icon("adsr.svg"),
                inputs=[
                    PortSpec(
                        id="kamp",
                    ...
                    PortSpec(id="irise", name="Rise", signal_type=SignalType.INIT, default=0.01),
                    PortSpec(id="idec", name="Decay", signal_type=SignalType.INIT, default=0.2),
                    PortSpec(id="ifn", name="EnvTable", signal_type=SignalType.INIT, default=1),
                    PortSpec(id="iatss", name="AttackSustain", signal_type=SignalType.INIT, default=1),
                    PortSpec(id="iatdec", name="AttackDecay", signal_type=SignalType.INIT, default=0.01),
                    PortSpec(id="ixmod", name="CrossfadeMode", signal_type=SignalType.INIT, required=False, default=0),
                    PortSpec(id="irind", name="IndexMode", signal_type=SignalType.INIT, required=False, default=0),
                ],
                outputs=[PortSpec(id="kenv", name="kEnv", signal_type=SignalType.CONTROL)],
                template="{kenv} envlpxr {kamp}, {irise}, {idec}, {ifn}, {iatss}, {iatdec}, {ixmod}, {irind}",
                tags=["control", "envelope", "release", "table"],
            ),
            self._spec(
                name="transegr",
                category="envelope",
                description="Control-rate transition envelope with release-triggered final segment.",
                icon=self._icon("adsr.svg"),
                inputs=[
                    PortSpec(id="ia", name="Start", signal_type=SignalType.INIT, default=0),
                    PortSpec(id="idur1", name="Dur1", signal_type=SignalType.INIT, default=0.05),
                    PortSpec(id="itype1", name="Type1", signal_type=SignalType.INIT, default=0),
                    PortSpec(id="ib", name="Val1", signal_type=SignalType.INIT, default=1.0),
                    PortSpec(id="idur2", name="Dur2", signal_type=SignalType.INIT, default=0.2),
                    PortSpec(id="itype2", name="Type2", signal_type=SignalType.INIT, default=0),
                    PortSpec(id="ic", name="Val2", signal_type=SignalType.INIT, default=0),
                ],
                outputs=[PortSpec(id="kenv", name="kEnv", signal_type=SignalType.CONTROL)],
                template="{kenv} transegr {ia}, {idur1}, {itype1}, {ib}, {idur2}, {itype2}, {ic}",
                tags=["control", "envelope", "segments", "transition", "release"],
            ),
            self._spec(
                name="oscili",
                category="oscillator",
            ...
            self._spec(
                name="oscil3",
                category="oscillator",
                description="Cubic-interpolating oscillator with low distortion.",
                icon=self._icon("oscili.svg"),
                inputs=[
                    PortSpec(
                        id="amp",
                ...
                outputs=[PortSpec(id="asig", name="aSig", signal_type=SignalType.AUDIO)],
                template="{asig} oscil3 {amp}, {freq}, {ifn}, {iphs}",
                tags=["sound", "source"],
            ),
            self._spec(
                name="poscil3",
            ...
            self._spec(
                name="grain",
                category="oscillator",
                description="Classic granular synthesis oscillator with table-based grains.",
                icon=self._icon("vco.svg"),
                inputs=[
                    PortSpec(
                        id="xamp",
                    ...
                    PortSpec(id="igfn", name="GrainTable", signal_type=SignalType.INIT, default=1),
                    PortSpec(id="iwfn", name="WindowTable", signal_type=SignalType.INIT, default=2),
                    PortSpec(id="imgdur", name="MaxGrainDur", signal_type=SignalType.INIT, default=1),
                    PortSpec(
                        id="i_max_grains",
                        name="MaxGrains",
                        signal_type=SignalType.INIT,
                ...
                outputs=[PortSpec(id="asig", name="aSig", signal_type=SignalType.AUDIO)],
                template=(
                    "{asig} grain {xamp}, {xpitch}, {xdens}, {kampoff}, {kpitchoff}, "
                    "{kgdur}, {igfn}, {iwfn}, {imgdur}, {i_max_grains}"
                ),
            ...
            self._spec(
                name="grain3",
                category="oscillator",
                description="Granular oscillator with independent frequency and phase modulation controls.",
                icon=self._icon("vco.svg"),
                inputs=[
                    PortSpec(
                        id="kcps",
                        ...
                        accepted_signal_types=[SignalType.CONTROL, SignalType.INIT],
                        default=10,
                        description="Grain frequency in cycles per second.",
                    ),
                    PortSpec(
                        id="kphs",
                        name="Phase",
                        ...
                        accepted_signal_types=[SignalType.CONTROL, SignalType.INIT],
                        default=0,
                        description="Start phase within the grain waveform table.",
                    ),
                    PortSpec(
                        id="kfmd",
                        name="FreqModDepth",
                        ...
                        accepted_signal_types=[SignalType.CONTROL, SignalType.INIT],
                        default=0,
                        description="Random frequency modulation depth applied to each grain.",
                    ),
                    PortSpec(
                        id="kpmd",
                        name="PhaseModDepth",
                        ...
                        accepted_signal_types=[SignalType.CONTROL, SignalType.INIT],
                        default=0,
                        description="Random phase modulation depth applied to each grain.",
                    ),
                    PortSpec(
                        id="kgdur",
                        name="GrainDuration",
                        ...
                        accepted_signal_types=[SignalType.CONTROL, SignalType.INIT],
                        default=0.05,
                        description="Duration of each grain in seconds.",
                    ),
                    PortSpec(
                        id="kdens",
                        name="Density",
                        ...
                        accepted_signal_types=[SignalType.CONTROL, SignalType.INIT],
                        default=20,
                        description="Average number of grains generated per second.",
                    ),
                    PortSpec(
                        id="imaxovr",
                        name="MaxOverlaps",
                        signal_type=SignalType.INIT,
                        default=64,
                        description="Maximum number of simultaneously active grains.",
                    ),
                    PortSpec(
                        id="kfn",
                        name="WaveformTable",
                        ...
                        accepted_signal_types=[SignalType.CONTROL, SignalType.INIT],
                        default=1,
                        description="Function table containing the source grain waveform.",
                    ),
                    PortSpec(
                        id="iwfn",
                        name="WindowTable",
                        signal_type=SignalType.INIT,
                        default=2,
                        description="Function table containing the grain envelope window.",
                    ),
                    PortSpec(
                        id="kfrpow",
                        name="FreqRangePower",
                        ...
                        accepted_signal_types=[SignalType.CONTROL, SignalType.INIT],
                        default=0,
                        description="Power curve shaping the random frequency distribution.",
                    ),
                    PortSpec(
                        id="kprpow",
                        name="PhaseRangePower",
                        signal_type=SignalType.CONTROL,
                        accepted_signal_types=[SignalType.CONTROL, SignalType.INIT],
                        default=0,
                        description="Power curve shaping the random phase distribution.",
                    ),
                    PortSpec(
                        id="iseed",
                        name="Seed",
                        ...
                        required=False,
                        default=0,
                        description="Optional random seed value.",
                    ),
                    PortSpec(
                        id="imode",
                        name="Mode",
                        ...
                        required=False,
                        default=0,
                        description="Optional processing mode selector.",
                    ),
                ],
                outputs=[
                    PortSpec(
                        ...
                        description="Granulated audio output signal.",
                    )
                ],
                template=(
                    "{asig} grain3 {kcps}, {kphs}, {kfmd}, {kpmd}, {kgdur}, {kdens}, {imaxovr}, "
                    "{kfn}, {iwfn}, {kfrpow}, {kprpow}, {iseed}, {imode}"
                ),
                tags=["sound", "source", "granular"],
            ),
            self._spec(
                name="granule",
                category="oscillator",
                description="Multi-voice granular processor with independent gap and grain-size controls.",
                icon=self._icon("vco.svg"),
                inputs=[
                    PortSpec(
                        id="xamp",
                    ...
                    PortSpec(id="ivoice", name="Voices", signal_type=SignalType.INIT, default=16),
                    PortSpec(id="iratio", name="PitchRatio", signal_type=SignalType.INIT, default=1),
                    PortSpec(id="imode", name="Mode", signal_type=SignalType.INIT, default=0),
                    PortSpec(id="ithd", name="Threshold", signal_type=SignalType.INIT, default=0),
                    PortSpec(id="ifn", name="SourceTable", signal_type=SignalType.INIT, default=1),
                    PortSpec(id="ipshift", name="PitchShift", signal_type=SignalType.INIT, default=0),
                    PortSpec(id="igskip", name="GrainSkip", signal_type=SignalType.INIT, default=0),
                    PortSpec(id="igskip_os", name="GrainSkipOffset", signal_type=SignalType.INIT, default=0),
                    PortSpec(id="ilength", name="TableLength", signal_type=SignalType.INIT, default=1),
                    PortSpec(
                        id="kgap",
                        name="Gap",
                        signal_type=SignalType.CONTROL,
                    ...
                    PortSpec(id="igap_os", name="GapOffset", signal_type=SignalType.INIT, default=0),
                    PortSpec(
                        id="kgsize",
                        name="GrainSize",
                        signal_type=SignalType.CONTROL,
                    ...
                    PortSpec(id="igsize_os", name="GrainSizeOffset", signal_type=SignalType.INIT, default=0),
                    PortSpec(id="iatt", name="AttackShape", signal_type=SignalType.INIT, default=0.5),
                    PortSpec(id="idec", name="DecayShape", signal_type=SignalType.INIT, default=0.5),
                    PortSpec(id="iseed", name="Seed", signal_type=SignalType.INIT, required=False, default=0),
                    PortSpec(id="ipitch1", name="Pitch1", signal_type=SignalType.INIT, required=False, default=1),
                    PortSpec(id="ipitch2", name="Pitch2", signal_type=SignalType.INIT, required=False, default=1),
                    PortSpec(id="ipitch3", name="Pitch3", signal_type=SignalType.INIT, required=False, default=1),
                    PortSpec(id="ipitch4", name="Pitch4", signal_type=SignalType.INIT, required=False, default=1),
                    PortSpec(id="ifnenv", name="EnvTable", signal_type=SignalType.INIT, required=False, default=0),
                ],
                outputs=[PortSpec(id="asig", name="aSig", signal_type=SignalType.AUDIO)],
                template=(
                    "{asig} granule {xamp}, {ivoice}, {iratio}, {imode}, {ithd}, {ifn}, {ipshift}, {igskip}, "
            ...
            self._spec(
                name="jitter",
                category="modulation",
                description="Control-rate segmented random line generator.",
                icon=self._icon("oscili.svg"),
                inputs=[
                    PortSpec(
                        id="kamp",
                ...
                outputs=[PortSpec(id="kout", name="kOut", signal_type=SignalType.CONTROL)],
                template="{kout} jitter {kamp}, {kcpsmin}, {kcpsmax}",
                tags=["control", "modulation", "random", "jitter"],
            ),
            self._spec(
                name="random",
                category="modulation",
                description="Control-rate random value generator between a minimum and maximum.",
                icon=self._icon("oscili.svg"),
                inputs=[
                    PortSpec(
                        id="kmin",
                ...
                outputs=[PortSpec(id="kout", name="kOut", signal_type=SignalType.CONTROL)],
                template="{kout} random {kmin}, {kmax}",
                tags=["control", "modulation", "random"],
            ),
            self._spec(
                name="randomh",
                category="modulation",
                description="Control-rate random sample-and-hold generator with update frequency control.",
                icon=self._icon("oscili.svg"),
                inputs=[
                    PortSpec(
                        id="kmin",
                    ...
                    PortSpec(id="imode", name="Mode", signal_type=SignalType.INIT, required=False, default=0),
                    PortSpec(id="ifirstval", name="FirstValue", signal_type=SignalType.INIT, required=False, default=0),
                ],
                outputs=[PortSpec(id="kout", name="kOut", signal_type=SignalType.CONTROL)],
                template="{kout} randomh {kmin}, {kmax}, {kcps}, {imode}, {ifirstval}",
                tags=["control", "modulation", "random", "sample-and-hold"],
            ),
            self._spec(
                name="randomi",
                category="modulation",
                description="Control-rate interpolated random generator with update frequency control.",
                icon=self._icon("oscili.svg"),
                inputs=[
                    PortSpec(
                        id="kmin",
                ...
                outputs=[PortSpec(id="kout", name="kOut", signal_type=SignalType.CONTROL)],
                template="{kout} randomi {kmin}, {kmax}, {kcps}, {imode}, {ifirstval}",
                tags=["control", "modulation", "random", "interpolated"],
            ),
            self._spec(
                name="release",
                category="modulation",
                description="Return 1 during note release phase and 0 otherwise.",
                icon=self._icon("oscili.svg"),
                inputs=[],
                outputs=[PortSpec(id="krel", name="kRelease", signal_type=SignalType.CONTROL)],
                template="{krel} release",
                tags=["control", "modulation", "release", "state"],
            ),
            self._spec(
                name="samphold",
                category="modulation",
            ...
            self._spec(
                name="vco2init",
                category="tables",
                description="Precompute band-limited wavetable sets for vco2 oscillators.",
                icon=self._icon("ftgen.svg"),
                inputs=[
                    PortSpec(id="iwave", name="WaveformSet", signal_type=SignalType.INIT, default=1),
                    PortSpec(id="ibasfn", name="BaseTable", signal_type=SignalType.INIT, required=False, default=-1),
                    PortSpec(id="ipmul", name="PartialMul", signal_type=SignalType.INIT, required=False, default=1.05),
                    PortSpec(id="iminsiz", name="MinSize", signal_type=SignalType.INIT, required=False, default=-1),
                    PortSpec(id="imaxsiz", name="MaxSize", signal_type=SignalType.INIT, required=False, default=-1),
                    PortSpec(id="isrcft", name="SourceTable", signal_type=SignalType.INIT, required=False, default=-1),
                ],
                outputs=[PortSpec(id="ifn", name="iNextTable", signal_type=SignalType.INIT)],
                template="{ifn} vco2init {iwave}, {ibasfn}, {ipmul}, {iminsiz}, {imaxsiz}, {isrcft}",
                tags=["tables", "init", "vco2"],
            ),
            self._spec(
                name="sfload",
                category="soundfont",
            ...
            self._spec(
                name="maxalloc",
                category="utility",
                description="Limit simultaneous instrument allocations for the compiled instrument.",
                icon=self._icon("const_i.svg"),
                inputs=[
                    PortSpec(id="icount", name="MaxVoices", signal_type=SignalType.INIT, default=8),
                ],
                outputs=[],
                template="maxalloc <auto-instr>, {icount}",
                tags=["utility", "allocation", "polyphony", "header"],
            ),
            self._spec(
                name="xtratim",
                category="utility",
                description="Extend current note duration by an additional init-time amount.",
                icon=self._icon("const_i.svg"),
                inputs=[PortSpec(id="iextradur", name="ExtraDur", signal_type=SignalType.INIT, default=0.2)],
                outputs=[],
                template="xtratim {iextradur}",
                tags=["utility", "timing", "release"],
            ),
            self._spec(
                name="upsamp",
                category="utility",
            ...
            self._spec(
                name="follow2",
                category="analysis",
                description="Envelope follower with independent attack and release controls.",
                icon=self._icon("k_to_a.svg"),
                inputs=[
                    PortSpec(id="asig", name="aIn", signal_type=SignalType.AUDIO),
                    PortSpec(
                ...
                outputs=[PortSpec(id="aout", name="aOut", signal_type=SignalType.AUDIO)],
                template="{aout} follow2 {asig}, {katt}, {krel}",
                tags=["analysis", "envelope", "follower", "control"],
            ),
            self._spec(
                name="pvsanal",
                category="spectral",
                description="Phase-vocoder analysis from an audio input to an fsig stream.",
                icon=self._icon("oscili.svg"),
                inputs=[
                    PortSpec(id="ain", name="aIn", signal_type=SignalType.AUDIO),
                    PortSpec(id="ifftsize", name="FFTSize", signal_type=SignalType.INIT, default=1024),
                    PortSpec(id="ioverlap", name="Overlap", signal_type=SignalType.INIT, default=256),
                    PortSpec(id="iwinsize", name="WindowSize", signal_type=SignalType.INIT, default=1024),
                    PortSpec(id="iwintype", name="WindowType", signal_type=SignalType.INIT, default=1),
                    PortSpec(id="iformat", name="Format", signal_type=SignalType.INIT, required=False, default=0),
                    PortSpec(id="iinit", name="Init", signal_type=SignalType.INIT, required=False, default=0),
                ],
                outputs=[PortSpec(id="fsig", name="fSig", signal_type=SignalType.FTABLE)],
                template="{fsig} pvsanal {ain}, {ifftsize}, {ioverlap}, {iwinsize}, {iwintype}, {iformat}, {iinit}",
                tags=["spectral", "phase-vocoder", "analysis", "fsig", "source"],
            ),
            self._spec(
                name="pvsmorph",
                category="spectral",
                description="Morph between two fsig streams by amplitude and frequency interpolation.",
                icon=self._icon("oscili.svg"),
                inputs=[
                    PortSpec(id="fsig1", name="fSig1", signal_type=SignalType.FTABLE),
                    PortSpec(id="fsig2", name="fSig2", signal_type=SignalType.FTABLE),
                    PortSpec(
                        id="kampint",
                        name="AmpInterp",
                        signal_type=SignalType.CONTROL,
                ...
                outputs=[PortSpec(id="fsig", name="fSig", signal_type=SignalType.FTABLE)],
                template="{fsig} pvsmorph {fsig1}, {fsig2}, {kampint}, {kfrqint}",
                tags=["spectral", "phase-vocoder", "morph", "fsig"],
            ),
            self._spec(
                name="pvshift",
                category="spectral",
                description="Shift fsig partial frequencies by a fixed amount in Hz.",
                icon=self._icon("oscili.svg"),
                inputs=[
                    PortSpec(id="fsigin", name="fIn", signal_type=SignalType.FTABLE),
                    PortSpec(
                        id="kshift",
                        name="ShiftHz",
                        signal_type=SignalType.CONTROL,
                ...
                outputs=[PortSpec(id="fsig", name="fSig", signal_type=SignalType.FTABLE)],
                template="{fsig} pvshift {fsigin}, {kshift}, {klowest}, {kkeepform}, {kgain}, {kcoefs}",
                tags=["spectral", "phase-vocoder", "pitch", "shift", "fsig"],
            ),
            self._spec(
                name="pvsynth",
                category="spectral",
                description="Resynthesize audio from an fsig stream via overlap-add.",
                icon=self._icon("oscili.svg"),
                inputs=[
                    PortSpec(id="fsrc", name="fSource", signal_type=SignalType.FTABLE),
                    PortSpec(id="iinit", name="Init", signal_type=SignalType.INIT, required=False, default=0),
                ],
                outputs=[PortSpec(id="aout", name="aOut", signal_type=SignalType.AUDIO)],
                template="{aout} pvsynth {fsrc}, {iinit}",
                tags=["spectral", "phase-vocoder", "resynthesis", "fsig"],
            ),
            self._spec(
                name="pvsosc",
                category="spectral",
                description="Generate oscillator spectra directly as an fsig stream.",
                icon=self._icon("oscili.svg"),
                inputs=[
                    PortSpec(
                        id="kamp",
                    ...
                    PortSpec(id="isize", name="FFTSize", signal_type=SignalType.INIT, default=1024),
                    PortSpec(id="ioverlap", name="Overlap", signal_type=SignalType.INIT, required=False, default=256),
                    PortSpec(id="iwinsize", name="WindowSize", signal_type=SignalType.INIT, required=False, default=1024),
                    PortSpec(id="iwintype", name="WindowType", signal_type=SignalType.INIT, required=False, default=1),
                    PortSpec(id="iformat", name="Format", signal_type=SignalType.INIT, required=False, default=0),
                ],
                outputs=[PortSpec(id="fsig", name="fSig", signal_type=SignalType.FTABLE)],
                template="{fsig} pvsosc {kamp}, {kfreq}, {ktype}, {isize}, {ioverlap}, {iwinsize}, {iwintype}, {iformat}",
                tags=["spectral", "phase-vocoder", "oscillator", "fsig", "source"],
            ),
            self._spec(
                name="pvsvoc",
                category="spectral",
                description="Cross-synthesize fsig amplitudes and excitation frequencies.",
                icon=self._icon("oscili.svg"),
                inputs=[
                    PortSpec(id="famp", name="fAmp", signal_type=SignalType.FTABLE),
                    PortSpec(id="fexc", name="fExc", signal_type=SignalType.FTABLE),
                    PortSpec(
                        id="kdepth",
                        name="Depth",
                        signal_type=SignalType.CONTROL,
                ...
                outputs=[PortSpec(id="fsig", name="fSig", signal_type=SignalType.FTABLE)],
                template="{fsig} pvsvoc {famp}, {fexc}, {kdepth}, {kgain}, {kcoefs}",
                tags=["spectral", "phase-vocoder", "vocoder", "cross-synthesis", "fsig"],
            ),
            self._spec(
                name="pvswarp",
                category="spectral",
                description="Warp and shift the spectral envelope of an fsig stream.",
                icon=self._icon("oscili.svg"),
                inputs=[
                    PortSpec(id="fsigin", name="fIn", signal_type=SignalType.FTABLE),
                    PortSpec(
                ...
                outputs=[PortSpec(id="fsig", name="fSig", signal_type=SignalType.FTABLE)],
                template="{fsig} pvswarp {fsigin}, {kscal}, {kshift}, {klowest}, {kmeth}, {kgain}, {kcoefs}",
                tags=["spectral", "phase-vocoder", "warp", "formant", "fsig"],
            ),
            self._spec(
                name="pvsmooth",
                category="spectral",
                description="Smooth fsig amplitude and frequency trajectories with lowpass filtering.",
                icon=self._icon("oscili.svg"),
                inputs=[
                    PortSpec(id="fsigin", name="fIn", signal_type=SignalType.FTABLE),
                    PortSpec(
                ...
                outputs=[PortSpec(id="fsig", name="fSig", signal_type=SignalType.FTABLE)],
                template="{fsig} pvsmooth {fsigin}, {kacf}, {kfcf}",
                tags=["spectral", "phase-vocoder", "smoothing", "fsig"],
            ),
            self._spec(
                name="moogladder",
                category="filter",
            ...
            self._spec(
                name="resonx",
                category="filter",
                description="Multi-layer resonant band-pass filter.",
                icon=self._icon("moogladder.svg"),
                inputs=[
                    PortSpec(id="asig", name="aIn", signal_type=SignalType.AUDIO),
                    PortSpec(
                    ...
                    PortSpec(id="inumlayer", name="Layers", signal_type=SignalType.INIT, required=False, default=4),
                    PortSpec(id="iscl", name="ScaleMode", signal_type=SignalType.INIT, required=False, default=0),
                    PortSpec(id="iskip", name="SkipInit", signal_type=SignalType.INIT, required=False, default=0),
                ],
                outputs=[PortSpec(id="aout", name="aOut", signal_type=SignalType.AUDIO)],
                template="{aout} resonx {asig}, {xcf}, {xbw}, {inumlayer}, {iscl}, {iskip}",
                tags=["filter", "resonant", "bandpass"],
            ),
            self._spec(
                name="vclpf",
                category="filter",
            ...
            self._spec(
                name="pinkish",
                category="noise",
                description="Pinkening filter for shaping white noise toward a pink spectrum.",
                icon=self._icon("oscili.svg"),
                inputs=[
                    PortSpec(id="xin", name="aIn", signal_type=SignalType.AUDIO),
                    PortSpec(id="imethod", name="Method", signal_type=SignalType.INIT, required=False, default=0),
                ],
                outputs=[PortSpec(id="aout", name="aOut", signal_type=SignalType.AUDIO)],
                template="{aout} pinkish {xin}, {imethod}",
                tags=["noise", "filter", "color"],
            ),
            self._spec(
                name="noise",
                category="noise",
            ...
            self._spec(
                name="sekere",
                category="physical_modeling",
                description="PhISEM sekere shaker model.",
                icon=self._icon("vco.svg"),
                inputs=[
                    PortSpec(id="iamp", name="Amplitude", signal_type=SignalType.INIT, default=0.3),
                    PortSpec(id="idettack", name="Dettack", signal_type=SignalType.INIT, default=0.01),
                    PortSpec(id="inum", name="Objects", signal_type=SignalType.INIT, required=False, default=64),
                    PortSpec(id="idamp", name="Damping", signal_type=SignalType.INIT, required=False, default=0.5),
                    PortSpec(id="imaxshake", name="MaxShake", signal_type=SignalType.INIT, required=False, default=0.5),
                ],
                outputs=[PortSpec(id="asig", name="aSig", signal_type=SignalType.AUDIO)],
                template="{asig} sekere {iamp}, {idettack}, {inum}, {idamp}, {imaxshake}",
                tags=["sound", "physical-modeling", "source", "percussion"],
            ),
            self._spec(
                name="sleighbells",
                category="physical_modeling",
                description="PhISEM sleigh bells model.",
                icon=self._icon("vco.svg"),
                inputs=[
                    PortSpec(
                        id="kamp",
                    ...
                    PortSpec(id="idettack", name="Dettack", signal_type=SignalType.INIT, default=0.01),
                    PortSpec(id="inum", name="Objects", signal_type=SignalType.INIT, required=False, default=32),
                    PortSpec(id="idamp", name="Damping", signal_type=SignalType.INIT, required=False, default=0),
                    PortSpec(id="imaxshake", name="MaxShake", signal_type=SignalType.INIT, required=False, default=0),
                    PortSpec(id="ifreq", name="CenterFreq", signal_type=SignalType.INIT, required=False, default=2500),
                    PortSpec(id="ifreq1", name="ResFreq1", signal_type=SignalType.INIT, required=False, default=5300),
                    PortSpec(id="ifreq2", name="ResFreq2", signal_type=SignalType.INIT, required=False, default=6500),
                ],
                outputs=[PortSpec(id="asig", name="aSig", signal_type=SignalType.AUDIO)],
                template=(
                    "{asig} sleighbells {kamp}, {idettack}, {inum}, {idamp}, "
                    "{imaxshake}, {ifreq}, {ifreq1}, {ifreq2}"
                ),
                tags=["sound", "physical-modeling", "source", "percussion"],
            ),
            self._spec(
            ...
            self._spec(
                name="vdelayxs",
                category="delay",
                description="Stereo variable delay with high-quality sinc interpolation.",
                icon=self._icon("moogladder.svg"),
                inputs=[
                    PortSpec(id="asig", name="aIn1", signal_type=SignalType.AUDIO),
                    PortSpec(id="asig2", name="aIn2", signal_type=SignalType.AUDIO, default=0),
                    PortSpec(
                        id="adl",
                        name="DelayTime",
                        signal_type=SignalType.AUDIO,
                    ...
                    PortSpec(id="iws", name="WindowSize", signal_type=SignalType.INIT, default=1024),
                    PortSpec(id="ist", name="SkipInit", signal_type=SignalType.INIT, required=False),
                ],
                outputs=[
                    PortSpec(id="aout", name="aOut1", signal_type=SignalType.AUDIO),
                    PortSpec(id="aout2", name="aOut2", signal_type=SignalType.AUDIO),
                ],
                template="{aout}, {aout2} vdelayxs {asig}, {asig2}, {adl}, {imaxdel}, {iws}, {ist}",
                tags=["delay", "effect"],
            ),
            self._spec(
                name="vdelay3",
            ...
            self._spec(
                name="vcomb",
                category="delay",
                description="Variable-time comb reverb with controllable loop time.",
                icon=self._icon("moogladder.svg"),
                inputs=[
                    PortSpec(id="asig", name="aIn", signal_type=SignalType.AUDIO),
                    PortSpec(id="krvt", name="ReverbTime", signal_type=SignalType.CONTROL, default=2),
                    ...
                    PortSpec(id="imaxlpt", name="MaxLoopTime", signal_type=SignalType.INIT, default=1),
                    PortSpec(id="iskip", name="SkipInit", signal_type=SignalType.INIT, required=False, default=0),
                    PortSpec(id="insmps", name="DelaySamples", signal_type=SignalType.INIT, required=False, default=0),
                ],
                outputs=[PortSpec(id="aout", name="aOut", signal_type=SignalType.AUDIO)],
                template="{aout} vcomb {asig}, {krvt}, {xlpt}, {imaxlpt}, {iskip}, {insmps}",
                tags=["delay", "effect", "comb"],
            ),
            self._spec(
                name="reverb2",
                category="reverb",
            ...
            self._spec(
                name="powershape",
                category="distortion",
                description="Power-law waveshaper for controllable nonlinear distortion.",
                icon=self._icon("moogladder.svg"),
                inputs=[
                    PortSpec(id="ain", name="aIn", signal_type=SignalType.AUDIO),
                    PortSpec(
                    ...
                    PortSpec(id="ifullscale", name="FullScale", signal_type=SignalType.INIT, required=False, default=1),
                ],
                outputs=[PortSpec(id="aout", name="aOut", signal_type=SignalType.AUDIO)],
                template="{aout} powershape {ain}, {kshapeamount}, {ifullscale}",
