        ...
        return [
            ...
            OpcodeSpec(
                ...
                inputs=[
                    ...
                    PortSpec(id="freq", name="Frequency", signal_type=SignalType.CONTROL, default=440),
            ...
            OpcodeSpec(
                ...
                inputs=[PortSpec(id="value", name="Value", signal_type=SignalType.CONTROL, default=0.0)],
                outputs=[PortSpec(id="kout", name="kOut", signal_type=SignalType.CONTROL)],
                template="{kout} = {value}",
                tags=["source"],
            ),
            OpcodeSpec(
                ...
                inputs=[PortSpec(id="value", name="Value", signal_type=SignalType.INIT, default=0.0)],
            ...
            OpcodeSpec(
                ...
                inputs=[PortSpec(id="value", name="Value", signal_type=SignalType.AUDIO, default=0.0)],
                outputs=[PortSpec(id="aout", name="aOut", signal_type=SignalType.AUDIO)],
                template="{aout} = {value}",
                tags=["source"],
            ),
