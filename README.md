...
The `orchestron-performance-creator` CLI can build the standard always-on matrix with `edit add-standard-effects`, adding the reverb effect, compressor effect, and speaker output patches plus the usual send/dry routing chain.
